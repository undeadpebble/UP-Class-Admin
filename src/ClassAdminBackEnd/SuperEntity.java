...
public class SuperEntity {
	...
	/**
	 * @return
	 * creates a linkedlist with all the entities in it
	 */
	 ...
	 * @return
	 * creates the xml tree to draw the tree structure from
	 */
	 ...
	 * @param type
	 * @return
	 * finds the first entity with the correct type searching downwards in the tree
	 */
	 ...
	 * @param type
	 * @return
	 * searches up and down for the type
	 */
	 ...
	 * @param originator
	 * @return
	 * finds the first entity with the correct type searching upwards in the tree
	 */
	...
	/**
	 * @return
	 * uses an iterative deepening search to find an IMGEntity
	 */
	 ...
	 * @param i
	 * @return
	 * used by IterativeDeepeningfindPortrait
	 */
