					...
					if (data.get(tcl.getRow()).get(tcl.getColumn()).getDetails().getType().getIsTextField()) {
						...
						try {
							if (Double.parseDouble((String) tcl.getNewValue()) >= 0 && data.get(tcl.getRow()).get(tcl.getColumn()).getType().getMaxValue() >= Double.parseDouble((String) tcl.getNewValue())) {
								...
								for(int x = 0; x < data.get(0).size();x++){
									table.getModel().setValueAt(data.get(tcl.getRow()).get(x).getValue(), tcl.getRow(), x);
								}
			...
			public Component prepareRenderer(TableCellRenderer renderer, int Index_row, int Index_col) {
				...
				try {
					...
					for (int x = 0; x < bordercases.size(); x++) {
						if (bordercases.get(x).isBorderCase(data.get(table.getRowSorter().convertRowIndexToModel(Index_row)).get(Index_col))) {
		...
		table.addMouseMotionListener(new MouseMotionAdapter() {
			public void mouseMoved(MouseEvent e) {
				...
				try {
					...
					LinkedList<Format> format = data.get(table.getRowSorter().convertRowIndexToModel(row)).get(col).getType().getFormatting();
					...
					public void actionPerformed(ActionEvent e) {
						...
						case 1: {
							if (whatToFormatCombo.getSelectedIndex() == 0) {
								headersList.get(headPoints.get(cbFormatting.getSelectedIndex())).getType().getFormatting()
										.add(new BetweenFormat(Double.parseDouble(minVal.getValue().toString()), Double.parseDouble(maxVal.getValue().toString()), null, colCombo.getColor(), description.getText()));

							} else {
								headersList.get(headPoints.get(cbFormatting.getSelectedIndex())).getType().getFormatting()
										.add(new BetweenFormat(Double.parseDouble(minVal.getValue().toString()), Double.parseDouble(maxVal.getValue().toString()), colCombo.getColor(), null, description.getText()));
						...
						case 2: {
							if (whatToFormatCombo.getSelectedIndex() == 0) {
								headersList.get(headPoints.get(cbFormatting.getSelectedIndex())).getType().getFormatting().add(new GreaterThanFormat(Double.parseDouble(minVal.getValue().toString()), null, colCombo.getColor(), description.getText()));
							} else {
								headersList.get(headPoints.get(cbFormatting.getSelectedIndex())).getType().getFormatting().add(new GreaterThanFormat(Double.parseDouble(minVal.getValue().toString()), colCombo.getColor(), null, description.getText()));
						...
						case 3: {
							if (whatToFormatCombo.getSelectedIndex() == 0) {
								headersList.get(headPoints.get(cbFormatting.getSelectedIndex())).getType().getFormatting().add(new LessThanFormat(Double.parseDouble(minVal.getValue().toString()), null, colCombo.getColor(), description.getText()));
							} else {
								headersList.get(headPoints.get(cbFormatting.getSelectedIndex())).getType().getFormatting().add(new LessThanFormat(Double.parseDouble(minVal.getValue().toString()), colCombo.getColor(), null, description.getText()));
					...
					addFilter.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							try {
								...
								case 1: {
									for (int x = 0; x < dataFilter.length; x++) {
										if (data.get(x).get(cbFilter.getSelectedIndex()).getMark() > Double.parseDouble(maxVal.getValue().toString())
												|| data.get(x).get(cbFilter.getSelectedIndex()).getMark() < Double.parseDouble(minVal.getValue().toString())) {
