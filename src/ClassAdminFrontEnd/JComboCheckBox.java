...
public class JComboCheckBox extends JComboBox {
  ...
  /*public static void main(String[] args) 
	{
	  	JCheckBox[] a = new JCheckBox[3];
	  	
	  	a[0] = new JCheckBox("ASDF", false);
	  	a[1] = new JCheckBox("qwer", false);
	  	a[2] = new JCheckBox("zxcv", false);
	  	
	  	JFrame test = new JFrame();
	  	JComboCheckBox temp = new JComboCheckBox(a);
